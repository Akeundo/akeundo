...
class Experience extends React.Component {
  render() {
              ...
              <div key={i}>
                <Media>
                  <Media left top href={experience.url}>
                    <Media object src={experience.logo} alt={""}/>
                  </Media>
                  <Media body>
                    <Media heading>
    ...
    // return 
    // <div>
    //   <h1>At Moment, I Got No Related Corporate Coding Experience </h1>
    //   <p>However i got a number of interesting personal projects te showcase my coding skills . I am currently seeking and internship position or a junior developer position to build coding team experience outsode school team projects.</p>
    // </div>
  }
}
