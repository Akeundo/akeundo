...
// import bclogo from './bclogo.json';
// import hankenlogo from './hankenlogo.json';
          ...
          {profile.studies.map(function (study, i) {
            return <Media key={i}>
              <Media left top href={study.url}>
                <Media object src={study.logo} alt={""}/>
                {/* <img object src={study.logo} alt={study.institute}/> */}
              </Media>
              <Media body>
                <Media heading>
          ...
          {profile.certifications.map(function (certification, i) {
            ...
            return <Media key={i}>
              ...
              <Media body>
                ...
                <Row className="row-acca">
                <strong>Expiring Date :</strong>{certification.expiryDate}
                  {/* <Col>{moment(certification.issueDate).format('MMM YYYY')} - {(certification.expiryDate) ? moment(certification.expiryDate).format('MMM YYYY') : 'Present'}</Col> */}
                </Row>
                <Row>
